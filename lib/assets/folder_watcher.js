...
class FolderWacther {
  ...
  _reGenerate() {
    ...
    Object.values(this.infos).forEach(info => {
      if (!infos[info.identifier]) {
        infos[info.identifier] = {
          varients: [info.path],
          ext: info.ext,
